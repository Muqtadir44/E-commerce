    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('Edit',function($data){
                 return '<button type="button" name="edit" id="'.$data->id.'" data-bs-toggle="modal" data-bs-target="#edit_category"class="edit-btn btn btn-sm text-primary">
                            <svg class="filament-link-icon w-4 h-4 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"></path>
                            </svg>
                        </button>
                        <button class="btn btn-sm text-danger" onclick="delete_category('.$data->id.')" id="'.$data->id.'" data-bs-toggle="modal" data-bs-target="#delete_category">
